	...
	<div id="board_list">	
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<thead>
				<tr>
					<th scope="col">강의명</th>
					<th width="250" scope="col">강의일시</th>
					<th width="250" scope="col">등록일</th>
				</tr>
			</thead>
			<tbody>
			<c:forEach var="b" items="${pb.list}">
			<tr onclick="improveView('${b.claim_no}')" onmouseover="this.style.backgroundColor='#effaf0'" onmouseout="this.style.backgroundColor=''" style="cursor:pointer;">
				<td>${b.class_name }</td>
...
<div id="dialog_improve_view" title="상의개선내역 상세보기"></div>
<!-- //교수 이의신청내역 -->
</div>
</div>
