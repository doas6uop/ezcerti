...
<div>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding:0px 5px 0px 5px">
		<tr>
			<td width="25%" height="30" align="center" class="deepgraytd">제목</td>
			<td class="graytd">
				<input id="title" name="title" class="searchtextbox" type="text" value="${board.title}" size="43" maxlength="100"/>
			</td>
		</tr>
		<tr>
			<td width="25%" height="30" align="center" class="deepgraytd">내용</td>
			<td class="graytd">
				<textarea id="contents" name="contents" rows="10" cols="35">${board.contents}</textarea>
			</td>
		</tr>
	</table>
</div>
