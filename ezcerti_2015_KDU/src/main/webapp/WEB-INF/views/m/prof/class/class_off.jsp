...
<div id="skip_lecture1">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="grayback">
      <td width="50%" height="40">
		<label><input type="radio" name="rdo_alter" value="ok" onchange="$('#add_lecture').css('display','block');" checked>대체수업(보강) 지정</label>
	  </td>
    </tr>
  </table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" id="add_lecture" style="display:block;">
    ...
    <tr>
      ...
      <td align="left">
      	<input type="text" id="alter_classoff_reason" name="alter_classoff_reason" class="searchtextbox" style="width:100px;">
      </td>
    </tr>
