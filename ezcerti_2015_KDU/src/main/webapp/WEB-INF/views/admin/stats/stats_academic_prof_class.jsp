...
<div id="btnArea" class="btnArea">
	<p align="left">
		<a href="${pageContext.request.contextPath}/muniv/stats/stats_academic_prof_class?prof_no=${classDetail.PROF_NO }&subject_cd=${classDetail.SUBJECT_CD }&subject_div_cd=${classDetail.SUBJECT_DIV_CD }&curr_year=${curr_year }&curr_term_cd=${curr_term_cd }&type=EXCEL">
