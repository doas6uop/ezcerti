...
$(document).ready(function(){
	$(".menu2 .top_menu_img").removeAttr("onmouseout").attr("src", "${pageContext.request.contextPath}/resources/images/top/topmenu_student_on.gif");
	$(".menu2 .aside_menu_img").removeAttr("onmouseout").attr("src", "${pageContext.request.contextPath}/resources/images/aside/smenu_student_on.gif");
...
function paging(currentPage){
	...
	f.action = '${pageContext.request.contextPath}/muniv/student/student_list';
	f.submit();
}
$(function(){
...
<c:set var="pb" value="${pageBean }"/>	
  <table width="670" border="0" cellpadding="0" cellspacing="0" >
    <tr>
      <td width="320" height="75" align="left" valign="bottom"><img src="${pageContext.request.contextPath}/resources/images/admin/sub_student_title_01.png"  alt="학생목록타이틀" /></td>
      <td width="340" align="right" valign="bottom"><img src="${pageContext.request.contextPath}/resources/images/admin/home_icon.png" width="22" height="12" alt="홈아이콘" /> &nbsp;학생&nbsp;<img src="${pageContext.request.contextPath}/resources/images/admin/small_arrow_icon.png" width="4" height="12" alt="화살표" /> &nbsp;학생목록 </td>
    </tr>
  </table>
</div>
<form id="searchForm" method="get" action="${pageContext.request.contextPath}/muniv/student/student_list" autocomplete="off">
...
<div id="board">
	...
	<div id="board_list">	
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<thead>
				<tr>
			        <th width="32" class="bg_left" scope="col">NO</td>
			        <th width="110" scope="col">단과</td>
			        <th width="135" scope="col">학과</td>
			        <th width="50" scope="col">학년</td>
			        <th width="90" scope="col">학번</td>
			        <th width="90" scope="col">이름</td>
			        <th width="90" scope="col">연락처</td>
			        <th width="50" scope="col">국적</td>
			        <th width="50" scope="col">상태</td>
				</tr>
			</thead>
			<tbody>
			<c:choose>
