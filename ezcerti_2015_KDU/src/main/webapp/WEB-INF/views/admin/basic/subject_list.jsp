...
function paging(currentPage){
	...
	f.action = '${pageContext.request.contextPath}/muniv/basic/subject_list';
	f.submit();
}
</script>
</head>
...
<div id="contents">
	...
	<div class="titlebg">
	  <table width="670" border="0" cellpadding="0" cellspacing="0" >
	    <tr>
	      <td width="320" height="75" align="left" valign="bottom"><img src="${pageContext.request.contextPath}/resources/images/admin/sub_basics_title_04.png"  alt="과목정보타이틀" /></td>
	      <td width="340" align="right" valign="bottom"><img src="${pageContext.request.contextPath}/resources/images/admin/home_icon.png" width="22" height="12" alt="홈아이콘" /> &nbsp;기초정보&nbsp;<img src="${pageContext.request.contextPath}/resources/images/admin/small_arrow_icon.png" width="4" height="12" alt="화살표" /> &nbsp;과목정보 </td>
	    </tr>
	  </table>
	</div>
	<br />
...
<form id="searchForm" method="get" action="${pageContext.request.contextPath}/muniv/basic/subject_list" autocomplete="off">
<div id="board">
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<thead>
				<tr>
			        ...
			        <th width="122" scope="col">과목코드</td>
			        <th width="102" scope="col">분반코드</td>
			        <th scope="col">과목명</td>
