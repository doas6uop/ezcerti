...
function paging(currentPage){
	...
	f.action = '${pageContext.request.contextPath}/muniv/basic/college_list';
	f.submit();
}
</script>
</head>
...
<div id="contents">
	...
	<div class="titlebg">
	  <table width="670" border="0" cellpadding="0" cellspacing="0" >
	    <tr>
	      <td width="320" height="75" align="left" valign="bottom"><img src="${pageContext.request.contextPath}/resources/images/admin/sub_basics_title_02.png"  alt="단과정보타이틀" /></td>
	      <td width="340" align="right" valign="bottom"><img src="${pageContext.request.contextPath}/resources/images/admin/home_icon.png" width="22" height="12" alt="홈아이콘" /> &nbsp;기초정보&nbsp;<img src="${pageContext.request.contextPath}/resources/images/admin/small_arrow_icon.png" width="4" height="12" alt="화살표" /> &nbsp;단과정보 </td>
	    </tr>
	  </table>
	</div>
	<br />
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0">
			...
			<thead>
				<tr>
			        ...
			        <th width="150" scope="col">단과코드</td>
			        <th scope="col">단과명</td>
			...
			<c:choose>
				<c:when test="${fn:length(pb.list)==0 }">
					<tr>
						<td class="tdwhite" colspan="4" align="center" style="padding:30px 0 30px 0; border-right:none;">검색결과가 존재하지 않습니다.</td>
					</tr>
				</c:when>
				<c:otherwise>
