...
function sendAjax() {
    ...
    $.ajax({
        url: "${pageContext.request.contextPath}/muniv/info/classoff_manage_insert_ok",
        data: frm,
        dataType : 'text',
        processData : false,
        contentType : false,
	...
	<form id="boardFrm" enctype="multipart/form-data" onsubmit="javascript:sendAjax(); return false;">
		...
		<div id="board_write">
			...
			<table border="0" cellpadding="0" cellspacing="0" summary="글쓰기">
				<caption>일괄휴강관리 등록</caption>
				<tr>
					<th>휴강처리일자</th>
					<td>
						<input type="text" id="sdate" name="classday" class="searchtextbox" value="${classday }" style="width:120px;" readonly="readonly">
					</td>
					<th>보강처리일자</th>
					<td>
						<input type="text" id="edate" name="before_classday" value="${before_classday }" class="searchtextbox" style="width:120px;" readonly="readonly">
					</td>
				</tr>
				<tr>
					<th>사유</th>
					<td colspan="3">
						<textarea id="classoffmanage_sayu" name="classoffmanage_sayu" rows="5" cols="10" style="border: 1px solid #7f9db9;" ></textarea>
					</td>
				</tr>
			</table>
		</div>
